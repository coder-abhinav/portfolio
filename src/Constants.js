...
export const SDE_1_DETAILS = [
  "Initiated a custom UI library for generating 3D drawings of mechanical auto parts using Three.js.",
  "Initialized Storybook design system for custom UI components and integrated 13+ components it into the project",
  "Implemented MongoDB Atlas search and created a custom reusable Autocomplete UI for the same.",
  "Developed Progressive filters API's",
  "Developed a custom API that integrated with the existing backend to streamline data flow between frontend applications and databases, improving response times by 40% for user requests across platforms",
];
...
export const CAPGRID_INTERN_DETAILS = [
  ...
  "Implemented lazy loading for all components and images.",
];

export const FREELANCE_DETAILS = [
  "Engineered a scalable system prioritizing shift assignments based on seniority and skillsets of over 100 staff members, leading to enhanced operational efficiency while meeting the demands of critical service periods.",
  "Designed and implemented a system to assign shift priorities based on seniority and skillset, ensuring optimal staffing during critical operational hours.",
  "We leveraged modern frontend technologies such as ReactJs, Redux, CSS3, and MUI to deliver responsive, scalable, and performant features across various devices.",
];
...
export const TESTEMONIALS = [
  {
    ...
    name: "Nishant Gupta",
    title: "Director - Technology @Capgrid",
...

  {
    ...
    name: "Mahender Dagar",
    title: "Director - Sourcing @Capgrid",
    image: DagarProfile,
  },
  {
    content:
...
export const RESUME_LINK =
  "https://drive.google.com/file/d/1KTRfT2ifVQm701ZtLO7K4PBmlV-WthC_/view?usp=sharing";
